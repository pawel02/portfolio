<!--
    Contains all of the controls for the website that are persistent across the website
    example is the scroll to top
-->
<script>
...
{#if scrollY > 20}
<div>
    <a href = "#top" in:fade class = "center" title="Go To Top" use:rippleAction>
